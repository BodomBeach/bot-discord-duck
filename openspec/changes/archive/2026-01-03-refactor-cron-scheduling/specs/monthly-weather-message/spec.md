# Spec: monthly-weather-message

## Overview
Automated monthly message that sends a weather analysis reminder to club members on the first day of each month at 11:00 AM Paris time.
